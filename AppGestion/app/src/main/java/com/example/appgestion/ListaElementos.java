...
public class ListaElementos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add(new ListaElementos.Encapsulador(R.drawable.vestidolentejuelas, "Vestido lentejuelas", "El vestido está decorado completamente con lentejuelas multicolor que forman un patrón brillante en tonos rosados, dorados y plateados. Es un vestido midi con un corte ajustado y detalles distintivos: el escote es cruzado en la parte superior, dejando una pequeña abertura en el centro del pecho, y tiene un diseño halter con tiras que se atan en el cuello. ", false));
        datos.add(new ListaElementos.Encapsulador(R.drawable.bolsomarron, "Bolso marrón cuero", "Diseño tipo hobo, amplio y funcional. Está en cuero de color marrón oscuro, con un acabado liso y elegante. Cuenta con dos cremalleras decorativas en la parte frontal que añaden un toque moderno", false));
        datos.add(new ListaElementos.Encapsulador(R.drawable.vaqueroballoon, "Vaquero Balloon", "Corte relajado tipo \"balloon\" con cinco bolsillos, costuras torcidas y cierre de cremallera con botón metálico. Su diseño combina comodidad y estilo, con un fit amplio y cintura de tiro medio", false));
        datos.add(new ListaElementos.Encapsulador(R.drawable.botasojales, "Botín ojales", "Diseño moderno y audaz, con un tacón alto estilizado y ojales metálicos decorativos que añaden un toque de vanguardia", false));
        datos.add(new ListaElementos.Encapsulador(R.drawable.faldaplisadapicos, "Falda plisada picos", "Con un diseño de estilo midi con un corte asimétrico que presenta un bajo en picos, lo que añade un toque moderno y fluido a su apariencia. Está confeccionada en un tejido ligero y suave que permite un movimiento elegante, ideal para combinar con prendas casuales o más formales", false));
